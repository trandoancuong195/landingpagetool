function excuseBanner(child, element) {
    ...
    `;
    child.html(`<div id="parent-${bannerId}"><h2 style="text-align: center">Banner</h2>
    <button type="button" class="btn btn-danger delete-content delete-content-${bannerId}" onclick="deleteContent('${bannerId}')">
                                <i class="fa fa-times" aria-hidden="true"></i>
                            </button></div>
    <div class='banner' id="banner-${bannerId}"></div>`);
